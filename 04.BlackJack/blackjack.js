...
function hit() {
    ...
    if (reduceAce(yourSum, yourAceCount) > 21) { //if your sum STILL is greater than 21 you can't draw more cards
        canHit = false;
    }
...
function reduceAce(playerSum, playerAceCount) { //try to reduce total sum if you have any aces
